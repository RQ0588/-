...
@interface ZHActionSheetView ()<UITableViewDataSource , UITableViewDelegate , UIGestureRecognizerDelegate>
...
@end
@implementation ZHActionSheetView
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        ...
        ZHActionSheetCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        if (cell==nil) {
            cell = [[ZHActionSheetCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
        }
